...
describe('DtsCreator', () => {
  ...
  describe('#create', () => {
    ...
    it('returns DtsContent instance from composing css whose has invalid ' +
        'import/composes', done => {
    ...
    it('returns DtsContent instance from the pair of path and ' +
        'contents', done => {
      creator
...
describe('DtsContent', () => {
  ...
  describe('#formatted', () => {
    ...
    it('returns empty object exportion when the result list ' +
        'has no items', done => {
