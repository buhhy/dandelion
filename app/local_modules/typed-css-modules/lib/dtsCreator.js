...
var DtsContent = function () {
  function DtsContent(_ref) {
    ...
    var searchDir = _ref.searchDir;
    var outDir = _ref.outDir;
    var rInputPath = _ref.rInputPath;
    var rawTokenList = _ref.rawTokenList;
      ...
      return new Promise(function (resolve, reject) {
        ...
        _this2.loader.fetch(filePath, "/", undefined, initialContents).then(function (res) {
          if (res) {
            ...
            var result = validKeys.map(function (className) {
              // Convert any dashes in CSS class names to camel case.
              var parts = className.split('-');
              var newClassName = parts
                  .slice(0, 1)
                  .concat(parts
                      .slice(1)
                      .map(function (part) {
              ...
              return 'export const ' + newClassName + ': string;';
            });
